...
# Remove NA's
SiteTrendDeltaMeanProb <- SiteTrendDeltaMeanProb[1:54,]
...
name_figure <- 'shark_bite_country_probs.png'
...
plot(c(1960:2013),SiteTrendDeltaMeanProb[,1], axes=F, ylim=c(0,1), ylab='', xlab='', type='n')
...
# Add fitted lines
points(c(1960:2013),SiteTrendDeltaMeanProb[,i], pch=16,type='l',lty=1.5)

text(1991,0.9,state_names[i],cex=1.2)
